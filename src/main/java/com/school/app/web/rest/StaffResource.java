...
/**
 * REST controller for managing {@link com.school.app.domain.Staff}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Staff> result = staffRepository
            ...
            .map(existingStaff -> {
                ...
                if (staff.getPhoto() != null) {
                    existingStaff.setPhoto(staff.getPhoto());
                }
                if (staff.getPhotoContentType() != null) {
                    existingStaff.setPhotoContentType(staff.getPhotoContentType());
                }
                if (staff.getIsTeachingStaff() != null) {
                    existingStaff.setIsTeachingStaff(staff.getIsTeachingStaff());
                }
