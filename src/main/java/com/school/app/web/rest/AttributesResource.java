...
/**
 * REST controller for managing {@link com.school.app.domain.Attributes}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Attributes> partialUpdateAttributes(
        ...
        Optional<Attributes> result = attributesRepository
            ...
            .map(existingAttributes -> {
                if (attributes.getClassName() != null) {
                    existingAttributes.setClassName(attributes.getClassName());
                }
