...
import com.school.app.repository.LabelRepository;
...
/**
 * REST controller for managing {@link com.school.app.domain.Label}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class LabelResource {
    ...
    public ResponseEntity<Label> updateLabel(@PathVariable(value = "id", required = false) final Long id, @RequestBody Label label)
    ...
    public ResponseEntity<Label> partialUpdateLabel(@PathVariable(value = "id", required = false) final Long id, @RequestBody Label label)
        throws URISyntaxException {
